...
export const TeamCreatePage = Loadable(
    lazy(() => import("../pages/dashboard/management/team/TeamCreatePage"))
);
export const TeamDetailsPage = Loadable(
    lazy(() => import("../pages/dashboard/management/team/TeamDetailsPage"))
);
export const TeamUserPermissionPage = Loadable(
    lazy(() =>
        import("../pages/dashboard/management/team/UserUpdatePermissionPage")
    )
);
...
export const QuestionListPage = Loadable(
    lazy(() =>
        import("../pages/dashboard/management/question/QuestionListPage")
    )
);
...
export const QuestionEditPage = Loadable(
    lazy(() =>
        import("../pages/dashboard/management/question/QuestionEditPage")
    )
);

// NOTIFICATION
export const NotificationListPage = Loadable(
    lazy(() => import("../pages/dashboard/notifications/NotificationListPage"))
);

// NOTIFICATION
export const CouponsListPage = Loadable(
    lazy(() => import("../pages/dashboard/management/coupons/CouponsListPage"))
);
